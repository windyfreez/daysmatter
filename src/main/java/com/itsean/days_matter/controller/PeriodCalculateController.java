...
import com.itsean.days_matter.Service.PeriodCalculateService;
...
public class PeriodCalculateController {
    ...
    @Autowired
    private PeriodCalculateService periodCalculateService;
    ...
    public Result<LocalDate> calculatePeriod(@Valid @RequestBody PeriodCalculateRequest request) {
        LocalDate result = periodCalculateService.periodCalculate(request);
